  ...
  <Dialog :open="isOpen" @update:open="handleOpenChange">
    <DialogContent class="max-w-2xl max-h-[80vh] overflow-hidden flex flex-col">
      ...
      <div
        ...
        class="p-3 bg-red-900/50 border border-red-700 rounded text-red-200 text-sm"
      >
      ...
      <div
        v-if="successMessage"
        class="p-3 bg-green-900/50 border border-green-700 rounded text-green-200 text-sm"
      >
        {{ successMessage }}
      </div>
