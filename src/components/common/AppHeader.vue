  ...
  >
    <div class="navbar-container">
      ...
      <div class="navbar-right-actions">
        <!-- View-only mode indicator (moved left of sync) -->
        <div
          v-if="isViewOnly"
          class="flex items-center gap-1 text-xs text-amber-400 bg-amber-900/50 px-2 py-1 rounded"
          title="You are in view-only mode. Contact an admin to make changes."
        >
